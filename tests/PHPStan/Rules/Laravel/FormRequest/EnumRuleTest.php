...
class EnumRuleTest extends CustomRuleTestCase
{
    ...
    public function testRule(): void
    {
        $this->analyse(
            ...
            [
                ['Property "enum-property-1" is has enum values in rules, but not in schema', 21],
                ['Property "enum-property-2" is has enum values in rules, but not in schema', 22],
                ['Property "enum-property-3" is has enum values in rules, but not in schema', 23],
            ]
        );
    }
